  ...
  return (
    <>
      <div className="row text-center mt-5 mb-5">
        <h1 className="fs-2" style={{ color: "var(--text-primary)" }}>
      ...
      >
        <div className="col-6 px-5">
          <p>
            ...
            AlphaTrade, fusing the concept of "Alpha"—the financial benchmark
            for superior investment performance—with modern, seamless "Trading"
            technology.
          </p>
          <p>
